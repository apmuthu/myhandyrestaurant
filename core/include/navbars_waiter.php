...
function navbar_trash($form='',$show_abort='',$start_data) {
	...
	$msg .= '
			...
			';
	if(!empty($form))
		$msg .= '<a href="#" onclick="JavaScript:document.'.$form.'.submit(); return false"><img src="'.IMAGE_OK.'" alt="'.ucfirst(phr('BACK_TO_TABLE')).'" border=0 width="32" height="32"></a>';
...
function navbar_lock_retry($show_abort='') {
	...
	$msg .= '
			...
			<td width=35>
				<a href="orders.php"><img src="'.IMAGE_OK.'" alt="'.ucfirst(phr('BACK_TO_TABLES')).'" border=0 width="32" height="32"></a>
			</td>
		</tr>
	</table>
	';
...
function navbar_form($form,$show_abort='') {
	...
	$msg .= '
			...
			<td width=35>
				<a href="#" onclick="JavaScript:document.'.$form.'.submit(); return false;"><img src="'.IMAGE_OK.'" alt="'.ucfirst(phr('BACK_TO_TABLE')).'" border=0 width="32" height="32"></a>
			</td>
		</tr>
	</table>
	';
...
function command_bar_table_horizontal(){
	...
	<table>
		<tr>
			...
			<td width=35>
				<a href="orders.php?command=close_confirm"><img src="'.IMAGE_CLOSE.'" alt="'.ucfirst(phr('CLOSE_TABLE')).'" border=0 width="32" height="32"></a>
			</td>
			<td width=35>
			</td>
			<td width=35>
