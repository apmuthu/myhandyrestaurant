...
class menu {
	...
	function main () {
		...
		******************************************************************************/
		...
		<script type="text/javascript" language="JavaScript1.2">
			...
			oM.fillImg="'.ROOTDIR.'/images/cm_fill.gif"; oM.fromTop=0; oM.fromLeft=0; oM.wait=300; oM.zIndex=400;
			oM.useBar=1; 
			oM.barWidth="100%"; 
			oM.barHeight="menu"; 
			oM.barX=0;
	...
	function dishes_categories($start_idx,$parent) {
		...
		$query .= " JOIN `".$lang_table."` WHERE ".$lang_table.".table_id=".$main_table.".id";
