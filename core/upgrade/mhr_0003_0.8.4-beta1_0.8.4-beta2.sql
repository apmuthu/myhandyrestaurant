...
# [add] [tables] [mhr_conf] [fields] [defaultval] [add] =  1 
# [remove] [tables] [mhr_orders] [fields] [payment] [remove] =  1 

#
# Upgrade SQL code
#

ALTER TABLE `mhr_conf` ADD `defaultval` mediumtext NOT NULL;
ALTER TABLE `mhr_orders` DROP `payment`;
...
#
# Generating time: 27 July 2004 at 15:41
#
...
INSERT INTO `mhr_conf` VALUES ('7', 'printing_system', 'cupsys', '0', 'cupsys');
...
INSERT INTO `mhr_conf_it` VALUES ('1', '1', '<b>Ingredienti per pagina.</b><br/>Indica il numero massimo di ingredienti mostrati per pagina nella pagina delle modifiche. Oltre questo numero verrà usata la lista alfabetica.');
INSERT INTO `mhr_conf_it` VALUES ('3', '3', '<b>Statistiche top list.</b><br/>Numero di piatti sul quale è calcolata la top list. Gli ultimi...');
INSERT INTO `mhr_conf_it` VALUES ('4', '4', '<b>Numero di piatti da mostrare nella top list.</b><br/>Es.: 3 -> vengono mostrati i primi 3 piatti più richiesti. (0 per disabilitare la visualizzazione della top list)');
...
INSERT INTO `mhr_conf_it` VALUES ('9', '9', '<b>Permetti disassociazione.</b><br/>Se attivo, il cassiere può disassociare un tavolo da un cameriere.');
...
INSERT INTO `mhr_conf_it` VALUES ('13', '13', '<b>Ripetizione intestazioni colonne.</b><br/>Indica ogni quante righe si deve ripetere l\'intestazione delle colonne nella zona contabilità.');
...
INSERT INTO `mhr_conf_it` VALUES ('26', '26', '<b>Reindirizzamento automatico alla lista tavoli.</b><br/>Indica dopo quanti secondi di inattività si viene riportati alla lista dei tavoli. (0 per disabilitare)');
...
INSERT INTO `mhr_conf_it` VALUES ('29', '29', '<b>Coperto - Nome</b><br />Nome the piatto \"coperto\" come apparirà nei conti e nelle statistiche.');
...
INSERT INTO `mhr_conf_it` VALUES ('34', '34', '<b>Permetti cancellazione veloce.</b><br/>Se attivo, i camerieri possono cancellare velocemente un ordine cliccando sull\'icona del cestino nella lista ordini, una volta raggiunta quantità 1.');
...
INSERT INTO `mhr_system` VALUES ('2', 'version', '0.8.4-beta2');
