...
# [add] [tables] [mhr_categories] [fields] [vat_rate] [add] =  1 
# [add] [tables] [mhr_conf] [fields] [bool] [add] =  1 
# [add] [tables] [mhr_dests] [fields] [template] [add] =  1 
# [add] [tables] [mhr_dishes] [fields] [visible] [add] =  1 
# [add] [tables] [mhr_ingreds] [fields] [override_autocalc] [add] =  1 
# [add] [tables] [mhr_ingreds] [fields] [visible] [add] =  1 
# [add] [tables] [mhr_orders] [fields] [dest_id] [add] =  1 
# [add] [tables] [mhr_vat_rates] [add] =  1 
# [remove] [tables] [mhr_ingreds] [fields] [override_autorun] [remove] =  1 
# [remove] [tables] [mhr_lang] [fields] [value] [remove] =  1 
# [remove] [tables] [mhr_account_dbs] [remove] =  1 

#
# Upgrade SQL code
#

ALTER TABLE `mhr_categories` ADD `vat_rate` mediumint(9) NOT NULL default '0';
ALTER TABLE `mhr_conf` ADD `bool` tinyint(4) NOT NULL default '0';
ALTER TABLE `mhr_dests` ADD `template` text NOT NULL;
ALTER TABLE `mhr_dishes` ADD `visible` tinyint(4) NOT NULL default '1';
ALTER TABLE `mhr_ingreds` CHANGE `override_autorun` `override_autocalc` tinyint(4) NOT NULL default '0';
ALTER TABLE `mhr_ingreds` ADD `visible` tinyint(4) NOT NULL default '1';
ALTER TABLE `mhr_orders` ADD `dest_id` mediumint(9) NOT NULL default '0';
CREATE TABLE `mhr_vat_rates` (  `id` mediumint(9) NOT NULL auto_increment,  `name` text NOT NULL,  `rate` decimal(3,2) NOT NULL default '0.00',  PRIMARY KEY  (`id`)) TYPE=MyISAM;
ALTER TABLE `mhr_lang` DROP `value`;
DROP TABLE `mhr_account_dbs`;
...
#
# Generating time: 20 May 2004 at 02:15
#
...
INSERT INTO `mhr_conf` VALUES ('8', 'association_automatic', '1', '1');
...
INSERT INTO `mhr_conf` VALUES ('23', 'files_debug_dest', '/var/www/myhandyrestaurant/debug.log', '0');
INSERT INTO `mhr_conf` VALUES ('24', 'files_error_dest', '/var/www/myhandyrestaurant/error.log', '0');
...
INSERT INTO `mhr_conf_en` VALUES ('1', '1', '<b>Ingredients per page.</b><br/>Sets the maximum number of ingredients showed on a single page in the modification page. Beyond this value the alfabetical list will be used.<br/>(Default: 5)');
...
INSERT INTO `mhr_conf_en` VALUES ('7', '7', '<b>Printing system.</b><br/>The available printing systems are:<br>
lp: for linux/unix systems<br>
cupsys: for linux/unix systems<br>
win: for MS-Windows sytems (not tested)');
...
INSERT INTO `mhr_conf_en` VALUES ('10', '10', '<b>Autocalc considers removed ingredients.</b><br/>If active, the automatic price calculator (based on added ingredients number) calculates a removed ingredient as a "-1", otherwise it just ignores them<br/>(Attention: this function is now disabled, setting won\'t make any difference).<br/>(Default: Off)');
...
INSERT INTO `mhr_conf_en` VALUES ('28', '28', '<b>Service fee - Price</b><br />
Amount of the Service fee charge per person. You can\'t give a percent value. (0 to disable service fee calculation)<br/>(Default: 1)');
INSERT INTO `mhr_conf_en` VALUES ('29', '29', '<b>Service fee - Name</b><br />
Name of the service fee dish as it will appear on bills and statistics.<br/>(Default: Service)');
...
INSERT INTO `mhr_conf_it` VALUES ('7', '7', '<b>Sistema di stampa.</b><br/>I sistemi di stampa disponibili ad oggi sono:<br>
lp: per sistemi linux/unix<br>
cupsys: per sistemi linux/unix<br>
win: per sistemi windows (non testato)');
...
INSERT INTO `mhr_conf_it` VALUES ('10', '10', '<b>Autocalc considera le modifche sottrattive.</b><br/>Se attivo, il sistema di calcolo automatico dei prezzi conteggia in negativo gli ingredienti rimossi, se no li ignora (attualmente inutilizzabile).<br/>(Default: Off)');
...
INSERT INTO `mhr_conf_it` VALUES ('15', '15', '<b>Tempo di blocco tavolo.</b><br/>Tempo in secondi che deve intercorrere tra due operazioni sullo stesso tavolo ad parte di camerieri diversi. Se uguale a 0 il blocco è disabilitato.<br/>(Default: 10)');
...
INSERT INTO `mhr_conf_it` VALUES ('19', '19', '<b>Quantità di default.</b><br/>Quantità usata di default quando si prende un piatto nuovo.<br/>(Default: 1)');
...
INSERT INTO `mhr_conf_it` VALUES ('23', '23', '<b>Indirizzo del file di log per il debugging.</b><br/>Indirizzo completo del file di log per il debugging. Se questa informazione è errata o il file non è scrivibile, il software genera un errore. (es: /var/www/handyrestaurant/debug.log o c:/logs/debug.log) ');
INSERT INTO `mhr_conf_it` VALUES ('24', '24', '<b>Indirizzo del file di log per gli errori.</b><br/>Indirizzo completo del file di log per gli errori. Se questa informazione è errata o il file non è scrivibile, il software genera un errore. (es: /var/www/handyrestaurant/errors.log o c:/logs/errors.log)');
...
INSERT INTO `mhr_conf_it` VALUES ('28', '28', '<b>Coperti - Prezzo</b><br />
Prezzo per persona del servizio in valuta. Non si può indicare un valore percentuale. (0 per disabilitare il calcolo dei coperti)<br/>(Default: 1)');
INSERT INTO `mhr_conf_it` VALUES ('29', '29', '<b>Coperto - Nome</b><br />
Nome the piatto "coperto" come apparirà nei conti e nelle statistiche.<br/>(Default: Service)');
...
INSERT INTO `mhr_lang_en` VALUES ('104', '116', 'Generic Dish (to be used for not previewed cases, such as a very special request)');
...
INSERT INTO `mhr_lang_en` VALUES ('162', '174', 'You must have fresh installed at least version 0.8.3-beta6 to use the upgrader.');
...
INSERT INTO `mhr_lang_it` VALUES ('79', '91', 'Controlla il nome');
...
INSERT INTO `mhr_lang_it` VALUES ('86', '98', 'Controlla il nome del database');
...
INSERT INTO `mhr_lang_it` VALUES ('104', '116', 'Piatto generico (da usare per i casi non previsti, come richieste molto particolari)');
...
INSERT INTO `mhr_lang_it` VALUES ('120', '132', 'Controlla il modello');
...
INSERT INTO `mhr_system` VALUES ('2', 'version', '0.8.3');
...
# [alter] [tables] [mhr_account_mgmt_main] [fields] [date] [alter] =  `date` timestamp(14) NULL -> `date` timestamp(14) NULL 
